...
public final class DockerPulumiApp
{
	...
	var
		backendImage =
		new RemoteImage(backendImageName, RemoteImageArgs.builder()
								 .name(String.format(
	...
	var
		frontendImage =
		new RemoteImage(frontendImageName, RemoteImageArgs.builder()
								  .name(String.format(
									  "pulumi/tutorial-pulumi-fundamentals-%s:latest",
									  frontendImageName))
								  .build());
	...
	var
		mongoImage =
		new RemoteImage("mongoImage", RemoteImageArgs.builder()
	...
	var
		network =
		new Network("network", NetworkArgs.builder()
	...
	var
		mongoContainer =
		new Container("mongoContainer", ContainerArgs.builder()
	...
	var
		backendContainer =
		new Container("backendContainer", ContainerArgs.builder()
	...
	var
		frontendContainer =
		new Container("frontendContainer", ContainerArgs.builder()
								...
								.envs(List.of(
									...
									String.format("HTTP_PROXY=backend-%s:%d",
