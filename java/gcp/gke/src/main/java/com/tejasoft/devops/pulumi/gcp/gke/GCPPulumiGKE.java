package com.tejasoft.devops.pulumi.gcp.gke;
...
public final class GCPPulumiGKE
{
    public static void main(final String[] aArgs)
    {
	Pulumi.run(GCPPulumiGKE::stack);
    }
	...
	ctx.export("servicePublicIP", service.status()
					     .applyValue(s -> s.orElseThrow()
							       .loadBalancer()
							       .orElseThrow())
					     .applyValue(status -> status.ingress()
									 .get(0)
									 .ip()
									 .orElseThrow()));
    }
